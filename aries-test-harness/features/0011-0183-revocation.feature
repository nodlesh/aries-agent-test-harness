Feature: Aries agent credential revocation and revocation notification RFC 0011 0183
   ...
   @T002.2-RFC0011 @RFC0011 @P1 @critical @AcceptanceTest @Schema_DriversLicense_Revoc @Indy @remove
   Scenario Outline: Credential revoked and replaced with a new updated credential, holder proves claims with the updated credential with timesstamp
      Given "2" agents
         | name  | role     |
         | Bob   | prover   |
   ...
   @T002.3-RFC0011 @RFC0011 @P1 @critical @AcceptanceTest @Schema_DriversLicense_Revoc @Indy @remove
   Scenario Outline: Credential revoked and replaced with a new updated credential, holder proves claims with the updated credential with timesstamp
      Given "2" agents
         | name  | role     |
         | Bob   | prover   |
